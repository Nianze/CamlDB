  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState30 ->
        ...
        | _ ->
            ...
            let (_menhir_stack, _menhir_s, _) = _menhir_stack in
            _menhir_errorcase _menhir_env (Obj.magic _menhir_stack) _menhir_s)
    | MenhirState130 | MenhirState59 | MenhirState13 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        (match _tok with
...
and _menhir_goto_separated_nonempty_list_COMMA_col_field_ : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.expr list) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    match _menhir_s with
    | MenhirState120 | MenhirState91 | MenhirState45 | MenhirState49 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        let _menhir_stack = Obj.magic _menhir_stack in
        let x = _v in
...
and _menhir_goto_value_field : _menhir_env -> 'ttv_tail -> _menhir_state -> (Ast.typ) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState26 ->
        ...
        _menhir_goto_cond_field _menhir_env _menhir_stack _menhir_s _v
    | MenhirState124 | MenhirState114 | MenhirState112 ->
        let _menhir_stack = Obj.magic _menhir_stack in
        assert (not _menhir_env._menhir_error);
        let _tok = _menhir_env._menhir_token in
        (match _tok with
...
and _menhir_goto_top_field : _menhir_env -> 'ttv_tail -> (Ast.top_t) -> 'ttv_return =
  fun _menhir_env _menhir_stack _v ->
    ...
    | FROM ->
        _menhir_reduce26 _menhir_env (Obj.magic _menhir_stack) MenhirState49
    | _ ->
        assert (not _menhir_env._menhir_error);
        _menhir_env._menhir_error <- true;
...
and _menhir_run136 : _menhir_env -> 'ttv_tail -> _menhir_state -> (string) -> 'ttv_return =
  fun _menhir_env _menhir_stack _menhir_s _v ->
    let _menhir_stack = (_menhir_stack, _menhir_s, _v) in
    let _menhir_env = _menhir_discard _menhir_env in
    let _tok = _menhir_env._menhir_token in
        ...
        | INTO ->
            ...
            | ID _v ->
                ...
                | LPAREN ->
                    ...
                    | RPAREN ->
                        _menhir_reduce26 _menhir_env (Obj.magic _menhir_stack) MenhirState120
                    | _ ->
                        assert (not _menhir_env._menhir_error);
                        _menhir_env._menhir_error <- true;
                ...
                | VALUES ->
                    ...
                    | LPAREN ->
                        ...
                        | RPAREN ->
                            _menhir_reduce32 _menhir_env (Obj.magic _menhir_stack) MenhirState112
                        | _ ->
                            assert (not _menhir_env._menhir_error);
                            _menhir_env._menhir_error <- true;
    ...
    | SEL ->
        ...
        | TOP ->
            ...
            | _ ->
                ...
                _menhir_errorcase _menhir_env (Obj.magic _menhir_stack) _menhir_s)
        | FROM ->
            _menhir_reduce26 _menhir_env (Obj.magic _menhir_stack) MenhirState45
        | _ ->
            assert (not _menhir_env._menhir_error);
            _menhir_env._menhir_error <- true;
